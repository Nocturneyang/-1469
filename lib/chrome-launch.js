...
const DEFAULT_ARGS = [
  ...
  '--disable-breakpad',
  '--disable-dbus',
  '--disable-features=Translate,MediaRouter,OptimizationHints,AudioServiceOutOfProcess,VizDisplayCompositor,UseDBusSystemTray',
...
function buildChromeLaunchConfig(sessionDir, options = {}) {
  ...
  const pipe = envFlag(env.WORKBENCH_WA_PUPPETEER_PIPE, true);
