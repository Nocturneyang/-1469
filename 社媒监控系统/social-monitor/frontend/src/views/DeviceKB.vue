        ...
        <div v-if="authStore.hasPermission('monitor:assets:write')" class="export-group">
          ...
          <div v-if="showExportMenu" class="export-menu">
            ...
            <button @click="downloadKB('jsonl')">
              ...
              <span>
                <strong>JSONL</strong>
                <small>RAG 训练集，每行 {instruction, output}</small>
              </span>
            </button>
...
onMounted(() => { fetchCategories(); fetchData(); document.addEventListener('click', handleOutsideClick) })
