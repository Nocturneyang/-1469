...
export WORKBENCH_ACCOUNT_WORKER_MAX_WORKERS="${WORKBENCH_ACCOUNT_WORKER_MAX_WORKERS:-5}"
export WORKBENCH_ACCOUNT_WORKER_MAX_WA="${WORKBENCH_ACCOUNT_WORKER_MAX_WA:-1}"
export WORKBENCH_ACCOUNT_WORKER_MAX_TG="${WORKBENCH_ACCOUNT_WORKER_MAX_TG:-4}"
