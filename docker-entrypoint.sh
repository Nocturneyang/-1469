...
export WORKBENCH_WA_WEB_CACHE_MAX_AGE_HOURS="${WORKBENCH_WA_WEB_CACHE_MAX_AGE_HOURS:-72}"
export WORKBENCH_CHANNEL_SYNC_RETRY_BASE_MS="${WORKBENCH_CHANNEL_SYNC_RETRY_BASE_MS:-30000}"
export WORKBENCH_CHANNEL_SYNC_RETRY_MAX_MS="${WORKBENCH_CHANNEL_SYNC_RETRY_MAX_MS:-600000}"
export WORKBENCH_SEND_ENABLED="${WORKBENCH_SEND_ENABLED:-0}"
export WORKBENCH_CHANNEL_RUNTIME_REQUIRED="${WORKBENCH_CHANNEL_RUNTIME_REQUIRED:-1}"
export WORKBENCH_ACCOUNT_WORKER_MAX_WORKERS="${WORKBENCH_ACCOUNT_WORKER_MAX_WORKERS:-13}"
export WORKBENCH_ACCOUNT_WORKER_MAX_WA="${WORKBENCH_ACCOUNT_WORKER_MAX_WA:-5}"
export WORKBENCH_ACCOUNT_WORKER_MAX_TG="${WORKBENCH_ACCOUNT_WORKER_MAX_TG:-8}"
export WORKBENCH_LOGIN_MAX_CONCURRENT_WA="${WORKBENCH_LOGIN_MAX_CONCURRENT_WA:-1}"
export WORKBENCH_LOGIN_MAX_CONCURRENT_TG="${WORKBENCH_LOGIN_MAX_CONCURRENT_TG:-1}"
